...
const API_KEY = '728bcf3a3d060970162e360e741159a5';
...
class DBService {
  ...
  constructor(){
    ...
    this.API_KEY = '728bcf3a3d060970162e360e741159a5';
  }
    ...
    getoWeek = () => this.getData( `${this.SERVER}/tv/on_the_air?api_key=${API_KEY}&language=ru-RU`);
  }
...
leftMenu.addEventListener('click', event => {
  ...
  if(target.closest('#week')) {
    tvShows.append(loading);
    dbService.getoWeek().then((response) => renderCard(response, target));
